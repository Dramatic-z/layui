package com.dnt.cloud.guide.enums;
...
public enum LogTypeCode {
	...
	LogTypeCode(String code, String message) {
		this.code = code;
		this.message = message;
	}

	public static LogTypeCode getByCode(String code) {
		for (LogTypeCode resultCode : LogTypeCode.values()) {
