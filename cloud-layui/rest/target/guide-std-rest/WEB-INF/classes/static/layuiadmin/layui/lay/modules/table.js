...
function(e) {
    ...
    d.exportFile2 = function(e, t, i) {
    	//e:选择导出的table的lay-filter属性值，t:需要导出的数据数组，i导出的文件后缀名。
        var a = this;
        //a:当前对象，包含config、cache、index属性  。
        t = d.clearCacheKey(d.cache[e]),
        i = i || "csv";
        for (var i = 0; i < t.length; i++) {
        	console.log(t[i]);
        	console.log(t[i].status);
		//	t[i].status=t[i].status==1?'在线':'离线';
		}
