...
public class FileUtil {
    ...
    /**
     * URL的文件路径
     * @param url 完整路径的URL地址串  
     * 	例如:    http://uploads.yjbys.com/allimg/201703/37-1F303164939645.png
     * @return 排除域名或者IP地址和文件名外的目录路径   /allimg/201703/
     */
    public static String getUrlFileDir(String url){
    	String fileDir = "/";
        ...
        // 转换路径
        String urlStr = normalizePath(url);
        
        String[] dirs = urlStr.split("/");
        if (dirs.length < 3) {
        	return null;
        }
        if (dirs.length == 3) {
    ...
    public static void main(String[] args) {
    	System.out.println(getUrlFileDir("http://uploads.yjbys.com/allimg/201703/37-1F303164939645.png"));
    	System.out.println(getUrlFileDir("http://uploads.yjbys.com/allimg/37-1F303164939645.png"));
		System.out.println(getUrlFileDir("http://uploads.yjbys.com/37-1F303164939645.png"));
	}
